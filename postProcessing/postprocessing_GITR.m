...
myDir = 'output_dev_0'; % west
% myDir = 'output_test'; % west
...
filename= '/Users/78k/Library/CloudStorage/OneDrive-OakRidgeNationalLaboratory/ORNL-ATUL-MBP/data/GITR_processing/preProcessing/west/west_54034_10p2s_mag.eqdsk';
...
for i=1:numSurfaces
 ...
 p4 = imagesc(linspace(0,90,90),linspace(0,60,nE),iead');
 set(gca,'YDir','normal')
